...
public class Post {
    ...
    public Post(int postId, String postTitle, String postContent, Date postDate, int categoryId, int useAcceptance, int likeAmount, int reportedAcceptance, int memberCode, Date postModifyDate) {
        this.postId = postId;
